...
for i = 1:n_tracts+1
    ...
    xline(datetime(2020,6,15), 'LineWidth',width,'Color',[240,195,45]/255);
    xticks([datetime(2020,5,25);datetime(2020,6,15);datetime(2020,6,30)])
    ylabel('I+R')  
...
% saveas(gcf,'plots\case1_prediction.jpg')




% prediction results of only selected regions
i_index = [3;6;7;8];
...
% saveas(gcf,'plots\case1_simple.jpg')
...
% saveas(gcf,'plots\case1_daily_prediction.jpg')
